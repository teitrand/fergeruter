...
import { setLang } from "../assets/i18n.js?v=39";
...
test("sida har den dekorative stiplede streken øverst", () => {
  ...
  assert.match(html, /assets\/styles\.css\?v=39/);
  assert.match(html, /assets\/app\.js\?v=39/);
  assert.match(app, /from "\.\/i18n\.js\?v=39"/);
  ...
  assert.match(sw, /fergeruter-dev-v39/);
