...
class FetchTests(unittest.TestCase):
    def test_main_writes_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual([line["id"] for line in data["lines"]], ["solavagen", "hundeidvika"])

    def test_lines_do_not_include_oye(self):
        self.assertEqual([item["id"] for item in mod.LINES], ["solavagen", "hundeidvika"])
