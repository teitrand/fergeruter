...
const STRINGS = {
  nn: {
    ...
    "mode.acuteNote": "Meldinga kom i dag. Tidlegare avgangar kan vere upålitelige.",
  ...
  en: {
    ...
    "mode.acuteNote": "The notice arrived today. Earlier departures may be unreliable.",
  ...
  de: {
    ...
    "mode.acuteNote": "Die Meldung kam heute. Frühere Abfahrten können unzuverlässig sein.",
