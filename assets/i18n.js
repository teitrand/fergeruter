...
const STRINGS = {
  nn: {
    ...
    eyebrow: "Hjørundfjorden · rute 1136",
    "eyebrow.1135": "Hjørundfjorden · rute 1135",
    "eyebrow.kombi": "Hjørundfjorden · kombinasjonsrute",
    ...
    "next.heading": "Neste tur",
    "next.headingFrom": "Neste frå {quay}",
    ...
    "lede.intro": "Kor ferja er, og når ho går.",
    "lede.noTripsToday": "Ingen turar i rutetabellen i dag.",
    "lede.nextDeparture": "Neste avgang {time} frå {from}, {countdown}",
    "issues.jumpOne": "Avvik i Hjørundfjorden",
    "issues.jumpMany": "{n} avvik i Hjørundfjorden",
  ...
  en: {
    ...
    eyebrow: "Hjørundfjorden · route 1136",
    "eyebrow.1135": "Hjørundfjorden · route 1135",
    "eyebrow.kombi": "Hjørundfjorden · combined timetable",
    "route.title1136": "Standal–Trandal–Sæbø–Skår–Valderøya–Store Kalvøy",
    "route.title1135": "Sæbø–Leknes",
    "route.titleKombi": "Sæbø–Leknes–Skår–Trandal–Standal",
    ...
    "next.heading": "Next sailing",
    "next.headingFrom": "Next from {quay}",
    ...
    "lede.intro": "Where the ferry is, and when it leaves.",
    "lede.noTripsToday": "No sailings in the timetable today.",
    "lede.nextDeparture": "Next departure {time} from {from}, {countdown}",
    "issues.jumpOne": "Disruption in Hjørundfjorden",
    "issues.jumpMany": "{n} disruptions in Hjørundfjorden",
  ...
  de: {
    ...
    eyebrow: "Hjørundfjorden · Linie 1136",
    "eyebrow.1135": "Hjørundfjorden · Linie 1135",
    "eyebrow.kombi": "Hjørundfjorden · Kombinationsfahrplan",
    "route.title1136": "Standal–Trandal–Sæbø–Skår–Valderøya–Store Kalvøy",
    "route.title1135": "Sæbø–Leknes",
    "route.titleKombi": "Sæbø–Leknes–Skår–Trandal–Standal",
    ...
    "next.heading": "Nächste Fahrt",
    "next.headingFrom": "Nächste ab {quay}",
    ...
    "lede.intro": "Wo die Fähre ist, und wann sie fährt.",
    "lede.noTripsToday": "Heute stehen keine Fahrten im Fahrplan.",
    "lede.nextDeparture": "Nächste Abfahrt {time} von {from}, {countdown}",
    "issues.jumpOne": "Störung am Hjørundfjord",
    "issues.jumpMany": "{n} Störungen am Hjørundfjord",
