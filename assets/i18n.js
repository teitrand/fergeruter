...
const STRINGS = {
  nn: {
    ...
    "messages.expand": "Vis meir",
    "messages.collapse": "Vis mindre",
    "messages.andNMore": "og {n} til",
    "messages.excerptMore": "…",
    "messages.countAria": "{n} meldingar",
    "route.badgeKombi": "Kombirute",
    "status.layoverAt": "Ferja ligg til kai på {quay}. Liggetid {duration}, til {time}.",
    "day.todayFull": "I dag · {date}",
    "extras.filterAria": "Ankomsttider og korrespondanse",
    "day.navAria": "Vel dag",
    "day.prev": "Førre dag",
    "day.next": "Neste dag",
    ...
    "stop.filterAria": "Vel frå og til",
    "place.from": "Frå",
    "place.to": "Til",
    "place.swap": "Byt frå og til",
    "place.via": "Via {via}, framme {time}",
    "place.transferVia": "Bytte på {hub} mot {to}. Vidare {time}, framme {arrival}.",
    "place.waitAt": "Vent på {quay} {duration}",
    "place.waitUntil": "til {time}",
    "route.label": "Vel samband",
    ...
    "layover.title": "Liggetid",
    "layover.atQuay": "Liggetid {quay}",
    "layover.until": "{duration}, til {time}",
    now: "No",
    ...
    "empty.noFrom": "Ingen turar frå {from} denne dagen.",
    "empty.noTo": "Ingen turar til {to} denne dagen.",
    "empty.noFromTo": "Ingen turar frå {from} til {to} denne dagen.",
  ...
  en: {
    ...
    "messages.expand": "Show more",
    "messages.collapse": "Show less",
    "messages.andNMore": "and {n} more",
    "messages.excerptMore": "…",
    "messages.countAria": "{n} notices",
    "route.badgeKombi": "Combined",
    "status.layoverAt": "The ferry is at {quay}. Layover {duration}, until {time}.",
    "day.todayFull": "Today · {date}",
    "extras.filterAria": "Arrival times and connections",
    ...
    "stop.filterAria": "Choose from and to",
    "place.from": "From",
    "place.to": "To",
    "place.swap": "Swap from and to",
    "place.via": "Via {via}, arriving {time}",
    "place.transferVia": "Change at {hub} towards {to}. Onward {time}, arriving {arrival}.",
    "place.waitAt": "Wait at {quay} {duration}",
    "place.waitUntil": "until {time}",
    "route.label": "Choose route",
    "route.1136": "Standal–Trandal",
    "route.1135": "Sæbø–Leknes",
    ...
    "layover.title": "Layover",
    "layover.atQuay": "Layover at {quay}",
    "layover.until": "{duration}, until {time}",
    now: "Now",
    "stops.all": "All stops",
    "view.label": "Display",
    ...
    "empty.noFrom": "No sailings from {from} this day.",
    "empty.noTo": "No sailings to {to} this day.",
    "empty.noFromTo": "No sailings from {from} to {to} this day.",
  ...
  de: {
    ...
    "messages.fetchedLive": "Zuletzt abgerufen {when} von Fjord1",
    ...
    "messages.expand": "Mehr anzeigen",
    "messages.collapse": "Weniger anzeigen",
    "messages.andNMore": "und {n} weitere",
    "messages.excerptMore": "…",
    "messages.countAria": "{n} Meldungen",
    "route.badgeKombi": "Kombi",
    "status.layoverAt": "Die Fähre liegt am Anleger {quay}. Liegezeit {duration}, bis {time}.",
    "day.todayFull": "Heute · {date}",
    "extras.filterAria": "Ankunftszeiten und Anschluss",
    ...
    "day.today": "Heute",
    "day.tomorrow": "morgen",
    "stop.filterAria": "Von und nach wählen",
    "place.from": "Von",
    "place.to": "Nach",
    "place.swap": "Von und nach tauschen",
    "place.via": "Über {via}, an {time}",
    "place.transferVia": "Umsteigen in {hub} nach {to}. Weiter {time}, an {arrival}.",
    "place.waitAt": "Warten in {quay} {duration}",
    "place.waitUntil": "bis {time}",
    "route.label": "Verbindung wählen",
    "route.1136": "Standal–Trandal",
    "route.1135": "Sæbø–Leknes",
    ...
    "layover.title": "Liegezeit",
    "layover.atQuay": "Liegezeit {quay}",
    "layover.until": "{duration}, bis {time}",
    now: "Jetzt",
    ...
    "empty.noFrom": "Keine Fahrten von {from} an diesem Tag.",
    "empty.noTo": "Keine Fahrten nach {to} an diesem Tag.",
    "empty.noFromTo": "Keine Fahrten von {from} nach {to} an diesem Tag.",
