...
const STRINGS = {
  nn: {
    ...
    "mode.kombiNote": "1135 og 1136 er innstilt. Sida viser kombinasjonsruta frå FRAM.",
    "mode.kombiPdf": "Kombinasjonsrute (FRAM)",
    "mode.only1135": "Rute 1136 er innstilt. Sida viser rute 1135 Sæbø–Leknes.",
    "mode.switchNote": "Frå {time}{quay} gjeld {table}. Før det {before}.",
    "mode.acuteNote": "Avgangar mellom {from} og {to} kan vere upålitelige.",
    ...
    "mode.vessel": "Ruta blir utført av M/F {name}.",
    ...
    "track.sailing": "På veg frå {from} til {to}",
    "track.reposition": "Flyttar seg frå {from} til {to}",
    "track.waiting": "Til kai på {quay}. Neste mot {to}",
    "track.moored": "Til kai på {quay}",
    "track.done": "Ferdig for dagen på {quay}",
    "track.aria": "Ferja er {percent} prosent på veg frå {from} til {to}",
  ...
  en: {
    ...
    "mode.kombiNote": "1135 and 1136 are cancelled. This page shows the FRAM combined timetable.",
    "mode.kombiPdf": "Combined timetable (FRAM)",
    "mode.only1135": "Route 1136 is cancelled. This page shows route 1135 Sæbø–Leknes.",
    "mode.switchNote": "From {time}{quay} the {table} applies. Before that, {before}.",
    ...
    "mode.vessel": "The route is operated by M/F {name}.",
    ...
    "track.sailing": "Heading from {from} to {to}",
    "track.reposition": "Repositioning from {from} to {to}",
    "track.waiting": "At {quay}. Next towards {to}",
    "track.moored": "At {quay}",
    "track.done": "Finished for the day at {quay}",
    "track.aria": "The ferry is {percent} percent of the way from {from} to {to}",
  ...
  de: {
    ...
    "mode.kombiNote":
      "1135 und 1136 fallen aus. Die Seite zeigt den Kombinationsfahrplan von FRAM.",
    "mode.kombiPdf": "Kombinationsfahrplan (FRAM)",
    "mode.only1135": "Linie 1136 fällt aus. Die Seite zeigt Linie 1135 Sæbø–Leknes.",
    "mode.switchNote": "Ab {time}{quay} gilt {table}. Davor {before}.",
    ...
    "mode.vessel": "Die Route wird von M/F {name} bedient.",
    ...
    "track.sailing": "Unterwegs von {from} nach {to}",
    "track.reposition": "Wechselt von {from} nach {to}",
    "track.waiting": "Am Anleger {quay}. Als Nächstes nach {to}",
    "track.moored": "Am Anleger {quay}",
    "track.done": "Für heute fertig in {quay}",
    "track.aria": "Die Fähre ist zu {percent} Prozent von {from} nach {to}",
